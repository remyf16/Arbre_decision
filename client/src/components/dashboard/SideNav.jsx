      ...
      <div className="flex flex-col h-full justify-between p-4">
        <div className="flex flex-col gap-6">
          ...
          <nav className="flex flex-col gap-2">
            ...
            <NavLink to="/editor/new" className={({ isActive }) => `${baseClasses} ${isActive ? activeClasses : inactiveClasses}`}>
                {/* Icon would go here */}
                {isSidebarOpen && <p className="text-sm font-medium leading-normal">Créer un arbre</p>}
            </NavLink>
